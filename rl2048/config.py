...
parser.add_argument('--exp_buffer_size', type=int, default=10**7)
...
parser.add_argument('--random_anneal_steps', type=int, default=10**7)
parser.add_argument('--reward_mode', type=str, default='normalized')
parser.add_argument('--gamma', type=float, default=0.99)
parser.add_argument('--update_every', type=int, default=10**5)
